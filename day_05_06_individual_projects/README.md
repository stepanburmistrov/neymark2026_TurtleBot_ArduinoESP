...
| Фото | Проект |
|---|---|
| <img src="images/participants/13_maksimov.jpg" alt="Максимов Кирилл Александрович" width="330"> | **Управление роботом жестами**<br><br>В проекте реализуется управление мобильным роботом с помощью жестов оператора.<br><br>**Ключевые направления:** Камера получает изображение человека, программа определяет заданные жесты и преобразует их в команды движения робота. |
