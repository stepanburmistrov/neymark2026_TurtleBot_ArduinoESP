...
| Фото | Проект |
|---|---|
| <img src="images/participants/05_vlasov.jpg" alt="Власов Павел Алексеевич" width="330"> | **Неделя в Неймарк: различные способы управления роботом**<br><br>На момент оформления страницы окончательная формулировка индивидуального проекта ещё не была зафиксирована.<br><br>**Ключевые направления:** будут добавлены после выбора темы. |
