...
| Фото | Проект |
|---|---|
| <img src="images/participants/05_vlasov.jpg" alt="Власов Павел Алексеевич" width="330"> | **Неделя в Неймарк: различные способы управления роботом**<br><br>Проект объединяет в одной программе несколько примеров и способов управления роботом, изученных в течение интенсива. Отдельные учебные программы собираются в единую систему, позволяющую запускать разные режимы работы и переключаться между ними. **Главная идея проекта** — не разработка одного нового алгоритма, а систематизация результатов всей недели и объединение изученных технологий в одно законченное приложение. Такой проект одновременно становится демонстрацией пройденного материала и основой, которую впоследствии можно дополнять новыми режимами управления.<br><br>**Ключевые направления:** будут добавлены после выбора темы. |
