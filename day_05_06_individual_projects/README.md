...
| 5 | Власов Павел Алексеевич | Неделя в Неймарк (различные способы управления) |https://github.com/Kapustik1337/Nemark_2026|
...
| 10 | Касторский Александр Васильевич | Подсчёт ящиков на полках |https://github.com/trynehol/IT_academy_project|
| 11 | Касумов Давид Октаевич | Распознавание оператора и управление жестами |https://github.com/kasdavik16-spec/FaceBot|
| 12 | Круглов Егор Павлович | Кегельринг |https://github.com/egor870/neymark2026|
| 13 | Максимов Кирилл Александрович | Управление роботом цветовыми шаблонами |https://github.com/km7283113-lang/NEYMARK-KIRILL|
...
| Фото | Проект |
|---|---|
| <img src="images/participants/13_maksimov.jpg" alt="Максимов Кирилл Александрович" width="330"> | **Управление роботом цветами**<br><br>В проекте реализуется управление мобильным роботом с помощью различных цветов.<br><br>**Ключевые направления:** Камера получает изображение, программа определяет заданные цвета и преобразует их в команды движения робота. |
